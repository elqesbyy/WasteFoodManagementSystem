Architecture Overview The project is split into three main components:
...
Business-Service (Spring Boot): Manages food listings, donations, and claims.

📡 Communication (RMI) The services communicate using Java RMI (Remote Method Invocation).
